    ...
    <div className="bg-slate-800 border border-slate-700 rounded-lg p-4 flex flex-col gap-3">
      ...
      <div className="flex flex-col gap-3">
        {opponentTexts.map((text, i) => {
          ...
          return (
            <div key={i} className="border border-slate-700 rounded-md overflow-hidden">
              <div
                className="flex items-center justify-between px-3 py-2 bg-slate-900 cursor-pointer"
