...
| Backend test baseline | Latest full documented run: **478 passed, 1 skipped** on 2026-05-05. Run with `cd backend && python3 -m pytest tests/ -x -q`. Prior: 466 passed (Session 8 handler fixes); 463 passed (2026-05-04). |
