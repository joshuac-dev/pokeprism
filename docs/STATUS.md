...
Reused handlers: `_fury_swipes`, `_take_down`, `_body_slam_deino`, `_scorching_fire`, `_take_down_recoil`, `_call_for_family_1`, `_burn_it_all_up`, `_damage_beat`, `_thunder_shock_dedenne`, `_surprise_attack_30`, `_big_bite`, `_collect`, `_dynamic_blaze` (also fixed to include energy discard on evolution condition)

Bug fixed: `_dynamic_blaze` (sv08.5-017) now correctly discards all Energy when the opponent's Active is an Evolution Pokémon.

New passive ability stubs: Oh No You Don't (Munkidori ex), ACE Nullifier (Genesect), Massive Body (Copperajah), Unnerve (Fraxure), Plasma Bane (Kyurem), Thicket Body (Tangrowth), Big Net (Ariados), Boom Boom Groove (Thwackey), Festival Lead (Dipplin/Goldeen), Storehouse Hideaway (Poltchageist), Alluring Light (Chandelure), Mentally Calm (Milotic), Zero to Hero (Palafin), Hero's Spirit (Palafin ex), Snack Seek (Morpeko), Initialization (Iron Thorns ex), Teleporter (Abra), Pyro Dance (Infernape)

### Flagged Cards (new this batch — 39)

| Card | TCGDex ID | Attack/Ability | Reason |
|------|-----------|---------------|--------|
| Okidogi ex SFA 36 | sv06.5-036 | Poisonous Musculature (atk0) | Search deck for 2 Basic Energy + attach — not supported |
| Munkidori ex SFA 37 | sv06.5-037 | Oh No You Don't (ability) | On-KO trigger — not supported |
| Copperajah SFA 42 | sv06.5-042 | Nasal Lariat (atk0) | Player choice extra damage + self attack lock — not supported |
| Copperajah SFA 42 | sv06.5-042 | Massive Body (ability) | Stadium restriction noop |
| Fraxure SFA 45 | sv06.5-045 | Unnerve (ability) | On-opponent-play trigger — noop |
| Haxorus SFA 46 | sv06.5-046 | Bring Down the Axe (atk0) | Conditional OHKO on Special Energy — not supported |
| Kyurem SFA 47 | sv06.5-047 | Plasma Bane (ability) | Discard pile condition — noop |
| Eevee SFA 50 | sv06.5-050 | Colorful Catch (atk0) | Search deck for 3 different-type Basic Energy — not supported |
| Furfrou SFA 51 | sv06.5-051 | Energy Assist (atk0) | Attach Basic Energy from discard to Bench — not supported |
| Bewear SFA 53 | sv06.5-053 | Power Charger (atk0) | Search deck for Basic Energy + attach to self — not supported |
| Pinsir TWM 3 | sv06-003 | Slow Crunch (atk0) | Deferred KO at end of opp's next turn — not supported |
| Ariados TWM 5 | sv06-005 | Big Net (ability) | Dynamic retreat cost modifier — noop |
| Volbeat TWM 9 | sv06-009 | Quick Sign (atk0) | First-turn condition + deck search — not supported |
| Illumise TWM 10 | sv06-010 | Slowing Perfume (atk0) | Second-player first-turn condition — not supported |
| Leafeon TWM 11 | sv06-011 | Leaflet Blessings (atk0) | Energy attach from hand + full heal — not supported |
| Thwackey TWM 15 | sv06-015 | Boom Boom Groove (ability) | Double attack with named ability — noop |
| Rillaboom TWM 16 | sv06-016 | Drum Beating (atk0) | Dynamic energy cost modifier — not supported |
| Dipplin TWM 18 | sv06-018 | Festival Lead (ability) | Double attack with Stadium — noop |
| Iron Leaves TWM 19 | sv06-019 | Recovery Net (atk0) | Put 2 Pokémon from discard to hand — not supported |
| Iron Leaves TWM 19 | sv06-019 | Avenging Edge (atk1) | Inter-turn KO tracking — not supported |
| Poltchageist TWM 21 | sv06-021 | Tea Server (atk0) | Put G Energy from discard to hand — not supported |
| Poltchageist TWM 20 | sv06-020 | Storehouse Hideaway (ability) | Bench ex damage prevention — noop |
| Sinistcha TWM 22 | sv06-022 | Cursed Drop (atk0) | Player choice counter placement — not supported |
| Sinistcha TWM 22 | sv06-022 | Spill the Tea (atk1) | Player choice energy discard count — not supported |
| Sinistcha ex TWM 23 | sv06-023 | Re-Brew (atk0) | Player choice counter placement per discard count — not supported |
| Teal Mask Ogerpon TWM 24 | sv06-024 | Mountain Stroll (atk0) | Deck search for 2 Basic Energy — not supported |
| Chandelure TWM 38 | sv06-038 | Alluring Light (ability) | Active draw — noop |
| Poliwrath TWM 43 | sv06-043 | Jumping Uppercut (atk1) | Player choice extra damage + self-shuffle — not supported |
| Goldeen TWM 44 | sv06-044 | Festival Lead (ability) | Double attack with Stadium — noop |
| Seaking TWM 45 | sv06-045 | Peck Off (atk0) | Discard opp Tools before damage — not supported |
| Jynx TWM 46 | sv06-046 | Inviting Kiss (atk0) | Energy transfer to newly benched Pokémon — partially supported (search works, move flagged) |
| Crawdaunt TWM 48 | sv06-048 | Snip Snip (atk0) | Opponent deck discard flip — not supported |
| Milotic TWM 50 | sv06-050 | Mentally Calm (ability) | Placement protection — noop |
| Snorunt TWM 51 | sv06-051 | Astonish (atk0) | Random hand card shuffle to deck — not supported |
| Glaceon TWM 54 | sv06-054 | Permeating Chill (atk0) | Deferred damage at end of opp's next turn — not supported |
| Phione TWM 55 | sv06-055 | Beckon (atk0) | Put Supporter from discard to hand — not supported |
| Froakie TWM 56 | sv06-056 | Flock (atk0) | Deck search for copies — not supported |
| Palafin TWM 60 | sv06-060 | Zero to Hero (ability) | On-retreat special placement — noop |
| Palafin ex TWM 61 | sv06-061 | Hero's Spirit (ability) | Placement restriction — noop |
| Iron Bundle TWM 62 | sv06-062 | Interjet (atk0) | Forced double switch — not supported |
| Luxray ex TWM 68 | sv06-068 | Piercing Gaze (atk0) | Reveal opp hand + discard a card — not supported |
| Morpeko TWM 72 | sv06-072 | Pick and Stick (atk0) | Attach 2 Basic Energy from discard — not supported |
| Morpeko TWM 72 | sv06-072 | Snack Seek (ability) | Top deck look — noop |
| Kilowattrel TWM 76 | sv06-076 | Wind Power Charge (atk0) | Inter-turn attack damage boost — not in state |
| Iron Thorns ex TWM 77 | sv06-077 | Volt Cyclone (atk0) | Energy transfer to bench — not supported |
| Iron Thorns ex TWM 77 | sv06-077 | Initialization (ability) | Attack-lock active — noop |
| Clefable TWM 79 | sv06-079 | Metronome (atk0) | Copy opp Active's attack — not supported |
| Abra TWM 80 | sv06-080 | Teleporter (ability) | Active shuffle to deck — noop |

### Final Baseline This Session
- **215 backend tests pass**
- **1453 cards in DB** (up from 1361)
- **Coverage: 98.0%** (1424/1453 implemented or flat-only; 29 missing — all pre-existing flagged)
- **~185 flagged cards total**
