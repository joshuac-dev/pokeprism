...
attacks.register_batch16_attacks(EffectRegistry.instance())
attacks.register_batch17_attacks(EffectRegistry.instance())
attacks.register_batch18_attacks(EffectRegistry.instance())
attacks.register_flagged_batch1_attacks(EffectRegistry.instance())
attacks.register_flagged_batch3_attacks(EffectRegistry.instance())
attacks.register_flagged_batch4_attacks(EffectRegistry.instance())
attacks.register_flagged_batch5_attacks(EffectRegistry.instance())
attacks.register_flagged_batch6_attacks(EffectRegistry.instance())
attacks.register_tm_attacks(EffectRegistry.instance())
