#!/usr/bin/env python3
"""Insert Batch 11 card definitions into the PostgreSQL cards table.

Cards covered:
  - SSP (sv08): 016–117

Already in DB (excluded):
  sv08-056, sv08-076, sv08-111

Usage:
    cd backend && python3 -m scripts.add_batch11_cards
"""
...
# Build full list: sv08-016..117
ALL_IDS: list[str] = []
for n in range(16, 118):
    cid = f"sv08-{n:03d}"
